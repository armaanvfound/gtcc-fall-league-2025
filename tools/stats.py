...
def build_payload():
    ...
    try:
        ...
        out['results2026'] = build_results2026()
    except Exception:
        out['results2026'] = None
    try:
        from standings2026 import build_standings2026
        out['standings2026'] = build_standings2026()
    except Exception:
        out['standings2026'] = None
    try:
        from leaders2026 import build_leaders2026
